        ...
        <dialog 
          ...
          <div className="modal-box">
            ...
            <input
              ...
              value={emailInDialog}
              // "(e)" refers to an evetn object that is passed to the onChange function when the input value changes. We can access the new value of the input field through "e.target.value" and update our state accordingly using setEmailInDialog.
              onChange={
                (e) => setEmailInDialog(
                  e.target.value
                )
